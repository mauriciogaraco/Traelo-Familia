...
const DRINKS: { key: string; name: string; price: number; image: string }[] = [
  ...
  { key: 'cerv-shekels', name: 'Cerv. Shekels', price: 400, image: '🍺' },
  { key: 'cerv-becks', name: 'Cerv. Becks', price: 380, image: '🍺' },
  { key: 'cerv-beer-azul', name: 'Cerv. Beer Azul', price: 380, image: '🍺' },
  { key: 'cerv-muralla', name: 'Cerv. Muralla', price: 380, image: '🍺' },
