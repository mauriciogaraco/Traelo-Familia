...
export const bodegaCentralProducts: Product[] = [
  ...
  { id: 'bc-005', name: 'Papel sanitario', businessId: ID, businessName: NAME, category: 'Aseo', shortDescription: 'Extra suave.', longDescription: 'Se vende por paca de 24 unidades.', image: '🧻', photo: Papel, price: 460, formato: 24, stockStatus: 'disponible' },
  { id: 'bc-008', name: 'Botonetas', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: 'Tira de 24 unidades.', longDescription: 'Se venden por tira de 24 unidades.', image: '🧀', photo: Botonetas, price: 50, formato: 24, stockStatus: 'disponible' },
  { id: 'bc-009', name: 'Chupa Chups XXXL', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: 'Estuche de 48 unidades.', longDescription: 'Se vende por estuches de 48 unidades.', image: '🍭', photo: ChupaChups, price: 45, formato: 48, stockStatus: 'disponible' },
  ...
  { id: 'bc-011', name: 'Culeros Lula', businessId: ID, businessName: NAME, category: 'Aseo', shortDescription: 'Pañales desechables.', longDescription: 'Se vende por unidad.', image: '🧷', photo: CulerosLula, price: 3500, stockStatus: 'disponible' },
  ...
  { id: 'bc-013', name: 'Galletas Coconut', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: 'De coco.', longDescription: 'Se vende por estuches de 12 unidades', formato: 12, image: '🍪', photo: Coconut, price: 80, stockStatus: 'disponible' },
  ...
  { id: 'bc-015', name: "Cuki's", businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: 'Elige una opción para añadir', longDescription: ' Se vende por estuche de 12 unidades', options: ['Vainilla', 'Chocolate'], image: '🍪', photo: Cukis, price: 940, stockStatus: 'disponible' },
  { id: 'bc-016', name: 'Donas', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: '', longDescription: ' Se vende por unidad.', image: '🍩', photo: Donas, price: 600, stockStatus: 'disponible' },
  ...
  { id: 'bc-019', name: 'Gelatina en pomo', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: 'Lista para comer.', longDescription: 'Gelatina en pomo. Se vende por pomos de 100 unidades', options: ['Pingüino', 'Mono'], image: '🍮', photo: GelatinaPomo, price: 3400, stockStatus: 'disponible' },
  ...
  { id: 'bc-021', name: 'Jabón de lavar', businessId: ID, businessName: NAME, category: 'Aseo', shortDescription: '', longDescription: ' Se vende por cajas de 96 unidades', formato: 96, image: '🧼', photo: JabonLavar, price: 232, stockStatus: 'disponible' },
  ...
  { id: 'bc-023', name: 'Galletas Jumbo', businessId: ID, businessName: NAME, category: 'Confituras', shortDescription: '', longDescription: 'Se vende por estuches de 12 unidades', formato: 12, image: '🧺', photo: Jumbo, price: 80, stockStatus: 'disponible' },
  ...
  { id: 'bc-027', name: 'Pastilla de pollo', businessId: ID, businessName: NAME, category: 'Alimentos', shortDescription: 'Sazón en pastilla.', longDescription: 'Pastilla saborizante de pollo . Se vende por caajita de 12 unidades.', formato: 12, image: '🧂', photo: PastillaPolloTomate, price: 15, stockStatus: 'disponible' },
  ...
  { id: 'bc-030', name: 'Espaguetis', businessId: ID, businessName: NAME, category: 'Alimentos', shortDescription: '500 gramos.', longDescription: 'Se vende por cajas de 20 unidades.', formato: 20, image: '🍝', photo: Spaguetti, price: 215, stockStatus: 'disponible' },
  { id: 'bc-031', name: 'Vinagre', businessId: ID, businessName: NAME, category: 'Alimentos', shortDescription: 'Pomo de 1 litro.', longDescription: 'Se vende por blister de 10 unidades.', formato: 10, image: '🧴', photo: Vinagre, price: 240, stockStatus: 'disponible' },
  { id: 'bc-032', name: 'Yogurt Vima', businessId: ID, businessName: NAME, category: 'Bebidas', shortDescription: 'x4', longDescription: ' Se vende por estuche de 4 vasitos', options: ['Fresa', 'Natural'], image: '🥛', photo: Yogurt, price: 840, stockStatus: 'disponible' },
